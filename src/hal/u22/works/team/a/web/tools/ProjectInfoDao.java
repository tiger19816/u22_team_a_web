...
public class ProjectInfoDao extends Dao {
    ...
    public void setDonation(String postNo, String memberNo, String donation)
        ...
        while (this.rs.next()) {
            ...
            if (this.rs.getInt("cleaning_flag") == 2
                    && this.rs.getInt("donation_money") >= this.rs.getInt("target_money")) {
                flg = "3";
            }
        }
        if (flg != "0") {
    ...
    //更新メソッド
    public void updateData(String supplierNo, String postNo, String fileName)
            throws SQLException, ClassNotFoundException {
